...
# HDF5 文件路径
hdf5_path = r"/home/mambauser/MMCode/data/stft_1d.h5"
...
def process_bin_file_hdf5(bin_path, wordIndex, fileIndex, personIndex, numTx, numRx):
    ...
    for TxRxIndex in range(numTx * numRx):
        # 选取某一个Rx的数据
        data_raw_rx = data_raw[TxRxIndex // numRx][TxRxIndex % numRx]
        ...
        # # 存储STFT结果到HDF5文件
        # save_to_hdf5(hdf5_path, wordIndex, fileIndex, personIndex, TxRxIndex, Zxx)
        ...
        for i in range(num_subplots):
            ...
            key = f"{wordIndex}_{fileIndex*num_subplots+i}_{personIndex}_{TxRxIndex}"
