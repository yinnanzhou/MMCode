...
# 原始数据路径
bin_path = r'C:\Users\yinnan\Desktop\YinnanRecord\20240824\ae\0_Raw_0.bin'

# 获取bin文件数据
data_raw = mmfunctions.getRawData(bin_path, numSamples, numChirps, numFrames,
...
# 提取相位并解缠绕
range_index, range_angle, angle_diff = mmfunctions.getUnwrapAngle(
    data_1dfft_dyn)
